...
class MapFragment : Fragment(), OnMapReadyCallback {
    ...
    override fun onMapReady(map: GoogleMap) {
        ...
        val defaultLocation = LatLng(41.37886123252744, 60.356932552303746)
    ...
    private fun updateMapMarkers(guides: List<Guide>) {
        ...
        guides.forEach { guide ->
            ...
            val lat = 41.37886123252744 + (Random.nextDouble() * 0.04 - 0.02)
            val lng = 60.356932552303746 + (Random.nextDouble() * 0.04 - 0.02)
